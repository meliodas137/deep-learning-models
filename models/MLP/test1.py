...
# print(J_autograd, J)
# print(y_hat_autograd, y_hat)

net_autograd.zero_grad()
J_autograd.backward()

# print(net_autograd.linear1.weight.grad.data, net.grads['dJdW1'], (net_autograd.linear1.weight.grad.data - net.grads['dJdW1']).norm() < 1e-3)
print(net_autograd.linear2.bias.grad.data, '\n', net.grads['dJdb2'], (net_autograd.linear1.bias.grad.data - net.grads['dJdb1']).norm() < 1e-3)
# print(net_autograd.linear2.weight.grad.data, '\n', net.grads['dJdW2'], (net_autograd.linear2.weight.grad.data - net.grads['dJdW2']).norm() < 1e-3)
